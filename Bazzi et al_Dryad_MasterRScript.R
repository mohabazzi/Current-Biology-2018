...
# R code by Mohamad Bazzi and Nicolas E. Campione, 2018.

# Data can be downloaded from Dryad: but also see article.
# We submit custom-made code (functions & loops) as separate R scripts. Code will run as long as all
...
#  To compute confidence and prediction intervals
